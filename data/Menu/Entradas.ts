...
export const entradas: MenuCategory = {
  ...
  groups: [
    //Entradas Group
    {
      ...
      price: "$14.900",
      image: "/Entradas/Papas-Rusticas.png",
      tags: ["vegetariano"],
      isVegetarian: true,
        },
        {
      ...
      price: "$25.400",
      image: "/Entradas/Picada-para-empezar.png",
      tags: [],
        },
        {
      id: 5,
      ...
      description: "",
      price: "$7.400",
      image: "/Entradas/Porcion-de-papas.webp",
      tags: ["vegetariano"],
      isVegetarian: true,
        },
    ...
    //Entradas Dips Group
    {
      ...
      description: "",
      price: "$2.600",
      image: "/Entradas/Mani-tostado.webp",
      tags: ["vegetariano"],
      isVegetarian: true,
        },
        {
      ...
      description: "",
      price: "$2.800",
      image: "/Entradas/Aceitunas-marinadas.webp",
      tags: ["vegetariano"],
      isVegetarian: true,
        },
        {
      ...
      description: "",
      price: "$3.400",
      image: "/Entradas/Queso-gouda.webp",
      tags: ["vegetariano"],
      isVegetarian: true,
        },
        {
      ...
      description: "",
      price: "$4.000",
      image: "/Entradas/Chorizo-seco.webp",
      tags: [],
        },
        {
      id: 10,
      ...
      price: "$5.000",
      image: "/Entradas/Ravioles-fritos.webp",
      tags: [],
        },
        {
      id: 11,
      ...
      price: "$6.500",
      image: "/Entradas/Croquetas-de-pollo.webp",
      tags: [],
        },
        {
      id: 12,
      ...
      price: "$5.800",
      image: "/Entradas/Adicional-de-papas.webp",
      tags: ["vegetariano"],
      isVegetarian: true,
        },
